...
# Gera dist\CNC_BatchEditor\ com o .exe + _internal + data\presets (editavel).
# Copie a pasta dist\CNC_BatchEditor inteira para o pen drive e rode o .exe.
...
& $py -m PyInstaller --noconfirm --onedir --windowed --name CNC_BatchEditor --paths "$root" "$root\main.py"
...
$dist = "$root\dist\CNC_BatchEditor"
...
Write-Host "Copie a pasta CNC_BatchEditor para o pen drive e rode CNC_BatchEditor.exe"
